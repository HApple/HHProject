...
@interface EncryptionsExample ()
@property (nonatomic, strong) NSData *data;
@end

@implementation EncryptionsExample
...
- (void)viewDidLoad {
    ...
    [button setTitle:@"关闭菊花" forState:UIControlStateNormal];
...
- (IBAction)touchMessageAction:(id)sender {
    [HHProgressHUD showMessage:@"你好上了房间睡觉啦你好"];
    
}
- (IBAction)touchJuhuaAction:(id)sender {
