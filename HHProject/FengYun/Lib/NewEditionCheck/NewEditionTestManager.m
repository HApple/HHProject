...
#pragma mark - API
+ (void)checkNewEditionWithAppID:(NSString *)appID ctrl:(UIViewController *)containCtrl Type:(NSInteger)type {
    
    [[self shareManager] checkNewVersion:appID ctrl:containCtrl Type:type];
...
- (void)checkNewVersion:(NSString *)appID ctrl:(UIViewController *)containCtrl Type:(NSInteger)type {
